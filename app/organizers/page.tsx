            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
              ...
              <div className="hidden md:flex flex-1 px-4 md:px-6">
               ...
               <div className="flex gap-2 md:gap-3 flex-shrink-0 md:ml-auto w-full md:w-auto">
                 ...
                 <Link
                   href="/post"
                   className="flex-1 md:flex-none inline-flex items-center gap-2 px-2.5 py-1.5 md:px-3 md:py-2 bg-[rgb(var(--brand))] text-white rounded-xl text-xs md:text-sm font-medium hover:bg-[rgb(var(--brand))]/90 transition-colors"
                 >
                   Post Event
                 </Link>
               </div>
