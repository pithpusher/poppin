  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 bg-gradient-to-r from-red-500 to-red-400 text-white rounded-md hover:from-red-400 hover:to-red-300 transition-all shadow-sm hover:shadow-md text-xs"
      >
